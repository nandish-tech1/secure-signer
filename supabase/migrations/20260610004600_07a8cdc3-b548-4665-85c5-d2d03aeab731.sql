...
-- signers: color, order, notification timestamp
ALTER TABLE public.signers
  ADD COLUMN IF NOT EXISTS color text,
  ADD COLUMN IF NOT EXISTS order_index integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS notified_at timestamptz;

-- documents: signing mode + current signer for ordered flow
DO $$ BEGIN
...
-- signature_fields: required flag
ALTER TABLE public.signature_fields
  ADD COLUMN IF NOT EXISTS required boolean NOT NULL DEFAULT true;

-- profiles: saved signature/initials
